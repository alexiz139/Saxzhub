...
local bKorblox = New("TextButton", { Size = UDim2.new(1, 0, 0, 40), BackgroundColor3 = T.panel, Text = "Activar Korblox", TextColor3 = T.text, Font = Enum.Font.GothamBold, Parent = sSkins })
styleButton(bKorblox)
bKorblox.MouseButton1Click:Connect(ApplyKorblox)
local bHeadless = New("TextButton", { Size = UDim2.new(1, 0, 0, 40), BackgroundColor3 = T.panel, Text = "Activar Headless", TextColor3 = T.text, Font = Enum.Font.GothamBold, Parent = sSkins })
styleButton(bHeadless)
bHeadless.MouseButton1Click:Connect(ApplyHeadless)

-- SECCIÓN INFO
local sInfo = Sec(pgInfo, "Información")
New("TextLabel", { Size = UDim2.new(1, 0, 0, 80), BackgroundTransparency = 1, Text = "Bienvenido a Saxzhub\nOwner: alexiz139", TextColor3 = T.text, Font = Enum.Font.GothamMedium, TextSize = 14, Parent = sInfo })

-- BOTONES SIDEBAR
local function addBtn(name, pg)
    local b = New("TextButton", { Size = UDim2.new(1, 0, 0, 40), BackgroundColor3 = T.panel, Text = name, TextColor3 = T.text, Font = Enum.Font.GothamBold, Parent = sidebar })
    Cor(b, 8)
...
addBtn("INFO", "Info")
addBtn("COMBAT", "Combat")
addBtn("VISUAL", "Visual")
addBtn("SKINS", "Skins")
