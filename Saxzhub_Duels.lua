--[[ 
    Saxzhub Duels Script + Advanced Functions (Deep Repair)
    Owner: alexiz139
]]
...
New("UIListLayout", { Padding = UDim.new(0, 18), Parent = sidebar })
...
pgVisual.Parent = contentArea
local sVisual = Sec(pgVisual, "Visuales")
Tog(sVisual, "ESP Highlight", false, function(v) S.eP = v end)
