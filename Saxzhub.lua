...
if _G.SaxzhubLoaded then
    if CoreGui:FindFirstChild("SaxzhubMain") then CoreGui.SaxzhubMain:Destroy() end
    if CoreGui:FindFirstChild("ShootGui_Overlay_V19") then CoreGui.ShootGui_Overlay_V19:Destroy() end
    if CoreGui:FindFirstChild("SaxzhubRoleAlert") then CoreGui.SaxzhubRoleAlert:Destroy() end
    if CoreGui:FindFirstChild("SaxzhubTracersGui") then CoreGui.SaxzhubTracersGui:Destroy() end
    if CoreGui:FindFirstChild("SaxzhubNotifyContainer") then CoreGui.SaxzhubNotifyContainer:Destroy() end
    if CoreGui:FindFirstChild("SaxzhubGrabGunBtn") then CoreGui.SaxzhubGrabGunBtn:Destroy() end
    if CoreGui:FindFirstChild("SaxzhubInvisBtn") then CoreGui.SaxzhubInvisBtn:Destroy() end
    if CoreGui:FindFirstChild("SaxzhubDesyncBtn") then CoreGui.SaxzhubDesyncBtn:Destroy() end
    if CoreGui:FindFirstChild("SaxzhubRoundTimer") then CoreGui.SaxzhubRoundTimer:Destroy() end
end
_G.SaxzhubLoaded = true
...
local function ApplyShowRoundTimer(state)
    if state then
        ...
        roundTimerGui.Name = "SaxzhubRoundTimer"
...
NotifyContainer.Name = "SaxzhubNotifyContainer"
...
GrabGunGui.Name = "SaxzhubGrabGunBtn"
...
DesyncGui.Name = "SaxzhubDesyncBtn"
...
local function ShowRoleAlert(role)
    ...
    if CoreGui:FindFirstChild("SaxzhubRoleAlert") then
        CoreGui.SaxzhubRoleAlert:Destroy()
    end
    
    local AlertGui = Instance.new("ScreenGui")
    AlertGui.Name = "SaxzhubRoleAlert"
...
TracerGui.Name = "SaxzhubTracersGui"
...
-- ANTI SILENT AIM (NOVO)
-- ==============================================================================
-- Hook para __index (spoof de CFrame)
local oldIndex = nil
...
-- Heartbeat loop para aplicar o desync
RunService.Heartbeat:Connect(function()
    if Config.AntiSilentAim then
        ...
        if char then
            ...
            if root and hum and hum.Health > 0 then
                ...
                -- Aplica posição falsa (random jitter)
        ...
        -- Se desligado, apenas limpa os dados salvos
        antiSilentAimData.savedCFrame = nil
        antiSilentAimData.savedVelocity = nil
    end
end)

-- Input para toggle via tecla e rejoin
